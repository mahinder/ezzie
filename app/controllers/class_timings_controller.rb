...
class ClassTimingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      #  flash[:notice] = 'Class timing was successfully created.'
        format.html { redirect_to :controller =>"class_timings",:class_timing =>@class_timing }
  ...
  def update
   ...
   #     flash[:notice] = 'Class timing updated successfully.'
        format.html { redirect_to :action =>"index",:class_timing=>@class_timing }
