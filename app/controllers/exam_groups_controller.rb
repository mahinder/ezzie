...
class ExamGroupsController < ApplicationController
  ...
  private
  def initial_queries
    puts "i m in last#{params}"
    @batch = Batch.find params[:batch], :include => :course unless params[:batch].nil?
