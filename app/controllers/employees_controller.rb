class EmployeesController < ApplicationController
  ...
  def admission1
    ...
    @school = Schooldatum.find_by_config_key('EmployeeNumberAutoIncrement')
    ...
    if request.post?
      ...
      if @employee.save
        ...
        redirect_to :controller =>"employees" ,:action => "admission2", :id => @employee.id
      end
  ...
  def add_category
    ...
    if request.post? and @category.save
      ...
      redirect_to :controller => "employees", :action => "add_category"
    end
  end
  ...
  def add_position
    ...
    if request.post? and @position.save
      ...
      redirect_to :controller => "employees", :action => "add_position"
    end
  end
  ...
  def add_department
    ...
    if request.post? and @department.save
      ...
      redirect_to :controller => "employees", :action => "add_department"
    end
  end
  ...
  def add_grade
    ...
    if request.post? and @grade.save
      ...
      redirect_to :controller => "employees", :action => "add_grade"
    end
  end
  ...
  def add_bank_details
    ...
    if request.post? and @bank_field.save
      ...
      redirect_to :controller => "employees", :action => "add_bank_details"
    end
  end
  ...
  def add_additional_details
    ...
    if request.post? and @additional_field.save
      ...
      redirect_to :controller => "employees", :action => "add_additional_details"
    end
  end
  ...
  def select_department
    puts "i am in employee select department"
