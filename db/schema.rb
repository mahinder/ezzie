...
ActiveRecord::Schema.define(:version => 20111115072140) do
  ...
  create_table "batch_transfers", :force => true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "country_states", :force => true do |t|
    t.string "name"
  end
  ...
  create_table "finance_transactions", :force => true do |t|
    ...
    t.datetime "updated_at"
    t.date     "transaction_date"
    t.decimal  "fine_amount",           :precision => 10, :scale => 0, :default => 0
