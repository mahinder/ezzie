class AddNewColumnsToFedena < ActiveRecord::Migration
  def self.up
    ...
    # Schooldatum.create :config_key => "NetworkState", :config_value=>"Online"
    # Schooldatum.create :config_key => "FinancialYearStartDate", :config_value=>Date.today
    # Schooldatum.create :config_key => "FinancialYearEndDate", :config_value=>Date.today+1.year
    # Schooldatum.create :config_key => "AutomaticLeaveReset", :config_value => "0"
    # Schooldatum.create :config_key => "LeaveResetPeriod", :config_value => "4"
    # Schooldatum.create :config_key => "LastAutoLeaveReset", :config_value => nil
  end
